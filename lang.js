...
(function () {
    ...
    const TRANSLATIONS = {
        en: {
            ...
            theme_switcher_hint: "Choose which banner theme is shown to everyone. \"Auto\" follows the calendar (Halloween: Oct 1 - Nov 2, Christmas: Dec 1 - 30).",
        ...
        it: {
            ...
            theme_switcher_hint: "Scegli quale tema del banner mostrare a tutti. \"Automatico\" segue il calendario (Halloween: 1 ott - 2 nov, Natale: 1 - 30 dic).",
        ...
        id: {
            ...
            theme_switcher_hint: "Pilih tema banner yang ditampilkan untuk semua orang. \"Otomatis\" mengikuti kalender (Halloween: 1 Okt - 2 Nov, Natal: 1 - 30 Des).",
        ...
        ph: {
            ...
            theme_switcher_hint: "Piliin kung aling tema ng banner ang ipapakita sa lahat. Ang \"Auto\" ay sumusunod sa kalendaryo (Halloween: Okt 1 - Nob 2, Pasko: Dis 1 - 30).",
        ...
        cn: {
            ...
            theme_switcher_hint: "选择要向所有人展示的横幅主题。“自动”将根据日历自动切换（万圣节：10月1日-11月2日，圣诞节：12月1日-30日）。",
        ...
        th: {
            ...
            theme_switcher_hint: "เลือกธีมแบนเนอร์ที่จะแสดงให้ทุกคนเห็น \"อัตโนมัติ\" จะเป็นไปตามปฏิทิน (ฮาโลวีน: 1 ต.ค. - 2 พ.ย., คริสต์มาส: 1 - 30 ธ.ค.)",
